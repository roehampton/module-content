...
4. Now you can add some 'nodes' to your pane.  When you add different interface elements you may need to add 'import' statements to ensure the correct libraries are present.  IntelliJ should prompt you for these.
